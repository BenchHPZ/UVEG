...
diagrama que se solicita en el Reto.
	...
	producto
*/
ALTER TABLE productos ADD id_tienda INT NOT NULL;
...
ALTER TABLE  detalle_orden_compra ADD FOREIGN KEY 
	(id_producto) REFERENCES productos(id);
ALTER TABLE  detalle_orden_compra ADD FOREIGN KEY 
	(id_orden_compra) REFERENCES orden_compra(id);
...
/*
	...
	https://github.com/BenchHPZ/UVEG-IngSisComp/tree/master/TallerDeBasesDeDatos/Actividades/assets//*Reto 2. Crear mi primera base de datos
1. Datos de identificacion
	- Nombre: 			Benjamin Rivera
	- Matricula: 		19015478
	- Fehca elaboracion:6 de Agosto de 2020
